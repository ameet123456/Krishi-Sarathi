...
const Dashboard = () => {
  ...
  const getFarmingTips = (weather) => {
    ...
    if (weather.condition.text.includes("Rain")) {
      tips.push(
        { type: "do", text: "Use rainwater harvesting for irrigation — Barsaat ka paani ikattha kar, future ke liye save kar." },
        { type: "dont", text: "Avoid spraying pesticides before rain — Barsaat se pehle dawai mat chhidak, sab beh jayegi bekaar mein." }
      );
    }
    // Hot conditions
    else if (weather.temp_c > 32) {
      tips.push(
        { type: "do", text: "Irrigate crops early morning or late evening — Subah ya shaam paani daal, dhoop mein mat." },
        { type: "dont", text: "Avoid midday watering — Dopehar mein paani dena waste hai bhai!" }
      );
    }
    // Humid conditions
    else if (weather.humidity > 75) {
      tips.push(
        { type: "do", text: "Check crops for fungus — Fungal disease dekho aur turant handle karo." },
        { type: "dont", text: "Avoid storing wet harvested crops — Geela anaj mat store kar, kharab ho jayega." }
      );
    }
    // Windy conditions
    else if (weather.wind_kph > 20) {
      tips.push(
        { type: "do", text: "Secure lightweight plants and mulch — Hawa zyada hai, sab ko sambhal ke rakh." },
        { type: "dont", text: "Don't spray pesticides in strong wind — Dawai hawa mein udd jayegi, bekaar hai." }
      );
    }
    // Default tips
    else {
      tips.push(
        { type: "do", text: "Monitor soil moisture regularly — Mitti ki nami check karte raho." },
        { type: "dont", text: "Avoid over-fertilizing — Zyada khaad mat daal, mitti kharab ho sakti hai." }
      );
    }
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                {tips.map((tip, idx) => (
                  <li key={idx} className="flex items-start">
                    {tip.type === "do" 
                      ...
                      : <XCircle className="text-red-500 mr-3 mt-0.5 flex-shrink-0" size={16} />
                    }
                    <span>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg">
            ...
            <div className="text-center">
              <p className="text-gray-600 text-lg mb-6 max-w-2xl mx-auto">
                Our team of agricultural experts is here to help you 24/7. Get personalized advice for your farming needs.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-green-50 p-6 rounded-xl">
                  <h4 className="font-semibold text-lg mb-2 text-gray-900">Phone Support</h4>
                  <p className="text-gray-600">1800-123-FARM</p>
                </div>
                <div className="bg-green-50 p-6 rounded-xl">
                  <h4 className="font-semibold text-lg mb-2 text-gray-900">Email Support</h4>
                  <p className="text-gray-600">help@krishisarathi.com</p>
                </div>
                <div className="bg-green-50 p-6 rounded-xl">
                  <h4 className="font-semibold text-lg mb-2 text-gray-900">Chat Support</h4>
          ...
          <div className="bg-gradient-to-r from-green-100 to-green-200 rounded-2xl p-12">
            ...
            <div className="text-center max-w-4xl mx-auto">
              <p className="text-gray-700 text-lg mb-6">
                Krishi Sarathi is your digital farming companion, empowering farmers with cutting-edge technology and expert knowledge. We combine traditional farming wisdom with modern agricultural science to help you make informed decisions.
              </p>
        ...
        <section className="bg-gradient-to-r from-green-100 to-green-200 rounded-2xl p-12 text-center shadow-lg">
          ...
          <p className="text-gray-700 text-lg mb-8 max-w-2xl mx-auto">
            Join thousands of smart farmers who are using technology to increase yield, reduce costs, and build a sustainable future.
          </p>
